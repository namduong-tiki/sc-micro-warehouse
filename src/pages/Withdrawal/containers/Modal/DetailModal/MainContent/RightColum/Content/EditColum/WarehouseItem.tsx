...
import { checkValidate } from '@/pages/Withdrawal/containers/Modal/CreateModal/StepScreen/Step2/TableBox/checkValidate';
...
const WarehouseItem = ({
  ...
  const saveValue = (obj: any) => {
    setNumberWithdrawal(obj?.warehouseCode, obj?.sku, obj?.value,obj?.weight,undefined);
    onChangeValueListSelected({sku:obj?.sku,value: obj?.value})
  };
